#!/usr/bin/env python3
"""
Script de régénération COMPLÈTE de l'analyse sémantique
"""
...
# CORRECTION DU CHEMIN - Ajouter le répertoire parent au PYTHONPATH
current_dir = Path(__file__).parent
project_root = current_dir.parent.parent  # Remonter deux niveaux
...
# Les imports DOIVENT être APRÈS l'ajout du chemin
